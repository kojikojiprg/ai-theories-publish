...
- 採用 step 数 950 は目安の 1000 step をわずかに下回った。主な要因は安全係数(2.0 倍)であり、較正自体の誤差は約 15% に収まっている。実際の所要時間は実験 C・E 合計で約 $29.7$ 分($1784.6\,\text{s}$)であり、70 分の予算の半分以下だった。安全係数を $1.3$ 程度に下げれば $1400$〜$1500$ step 程度を確保できる見込みである。
